...
private:
    std::vector<std::pair<Token, std::regex>> patterns = {
        ...
        {Token::kDot, std::regex(".")},
        {Token::kDotDot, std::regex("..")},
        {Token::kDotDotDot, std::regex("...")},
        {Token::kDotDotEq, std::regex("..=")},
        ...
        {Token::kDollar, std::regex("$")},
        {Token::kQuestion, std::regex(R"(\?)")},
        {Token::kTilde, std::regex("~")},

        {Token::kleftCurly, std::regex("{")},
        {Token::krightCurly, std::regex("}")},
        {Token::kleftSquare, std::regex("[")},
        {Token::kRightSquare, std::regex("]")},
        {Token::kleftParenthe, std::regex("(")},
        {Token::krightParenthe, std::regex(")")},
    };
